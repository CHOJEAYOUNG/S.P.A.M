...
public class EmploymentController {
	...
	public ModelAndView list(HttpServletRequest request, Employment employment, EmploymentCategory category, SpamUser spamuser) throws Exception {
...
//	public ModelAndView confirm(@RequestParam("file") MultipartFile file, HttpServletRequest request, Employment employment, EmploymentCategory category) throws Exception {
//		ModelAndView modelAndView = new ModelAndView("/employment/confirm");
//		String id = request.getParameter("id");
...
//	}
	...
	public ModelAndView add(@RequestParam("file") MultipartFile file, HttpServletRequest request, Employment employment, EmploymentCategory category) throws Exception {
		HttpSession session = request.getSession(false);
	...
	public ModelAndView remove(@PathVariable int no, HttpServletRequest request, Employment employment) throws Exception {
		HttpSession session = request.getSession(false);
