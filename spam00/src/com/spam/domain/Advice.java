...
public class Advice {
	...
	public String toString() {
		return "Advice [adviceNo=" + adviceNo + ", sId=" + sId + ", pId=" + pId + ", assentNo=" + assentNo + ", cause="
				...
				+ ", getAdviceNo()=" + getAdviceNo() + ", getsId()=" + getsId() + ", getpId()=" + getpId()
				+ ", getAssentNo()=" + getAssentNo() + ", getCause()=" + getCause() + ", getAssentDate()="
				+ getAssentDate() + ", getRegistration()=" + getRegistration() + ", getAdviceDate()=" + getAdviceDate()
				+ ", getReason()=" + getReason() + ", getMon()=" + getMon() + ", getTue()=" + getTue() + ", getWed()="
				+ getWed() + ", getThur()=" + getThur() + ", getFri()=" + getFri() + ", getQuarter()=" + getQuarter()
				+ ", getState()=" + getState() + ", getDay()=" + getDay() + ", getPeriod()=" + getPeriod()
