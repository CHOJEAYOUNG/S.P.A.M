				...
				<div class="container">
					<section>
						<header class="major">
							...
							<span class="byline">&hellip; a responsive HTML5 site
								...
								commercial) &ndash; just give us credit!
							</span>
						</header>
	...
	<div class="wrapper style2">
		<section class="container">
			...
			<div class="row no-collapse-1">
				<section class="4u">
					<a href="#" class="image feature"><img src="/html/images/pic02.jpg"
						alt=""></a>
					<p>Nam in massa. Sed vel tellus. Curabitur sem urna, consequat
						vel, suscipit in, mattis placerat.</p>
				</section>
				<section class="4u">
					<a href="#" class="image feature"><img src="/html/images/pic03.jpg"
						alt=""></a>
					<p>Donec ornare neque ac sem. Mauris aliquet. Aliquam sem leo,
						vulputate sed, convallis. Donec magna.</p>
				</section>
				<section class="4u">
					<a href="#" class="image feature"><img src="/html/images/pic04.jpg"
						alt=""></a>
					<p>Curabitur sem urna, consequat vel, suscipit convallis sem
						leo, mattis placerat, nulla. Sed ac leo.</p>
				</section>
						...
						<ul class="style">
							<li><span class="fa fa-wrench"></span>
								<h3>Integer ultrices</h3> <span>In posuere eleifend odio.
									...
									viverra vulputate enim.</span></li>
							<li><span class="fa fa-cloud"></span>
								<h3>Aliquam luctus</h3> <span>Pellentesque viverra
									vulputate enim. Aliquam erat volutpat. Maecenas condimentum
									enim tincidunt risus accumsan.</span></li>
						</ul>
					</section>
				</div>
				<div class="6u">
