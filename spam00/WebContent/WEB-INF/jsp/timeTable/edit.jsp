...
<body class="left-sidebar">
                     <form id="form" name="form" action="<c:url value="/timeTable/edit" />" method="post">
                  ...
                  <section>
                     ...
                     <table style="margin-left:15%;" >
                        <thead>
                              <thead>
                                    <tr>
                                       <th style=" text-align: center; background-color:#4C4639; width: 100px;">
                                       <font color="#FFFFFF">목록</font></th>
                                       <td style="width: 300px;">&nbsp&nbsp내용</td>
                                    </tr>
                                 </thead>
                              <tbody>
                                 <tr>
                                    <th style=" text-align: center; background-color:#4C4639; width: 100px;"><font color="#FFFFFF">교시</font>
                             </th>
                                 ...
                                 <tr>
                                    ...
                                    <td style="width: 300px;">
                                       <input type="text" id="beginHour" name="beginHour" value="${timeTable.beginHour}" maxlength="2" style="ime-mode: disabled; width: 130px;" /><font color="red">${message1}</font> : 
                                       <input type="text" id="beginMinutes" name="beginMinutes" value="${timeTable.beginMinutes}" maxlength="2" style="ime-mode: disabled; width: 130px;" /><font color="red">${message1}</font>
                                    </td>                                  
                                 </tr>
                                 <tr>
                                    <th style=" text-align: center; background-color:#4C4639; width: 100px;">
                                       ...
                                       <td style="style= width: 300px;">
                                          <input type="text" id="finishHour" name="finishHour" value="${timeTable.finishHour}" maxlength="2" style="ime-mode: disabled; width: 130px;"/>
                                             <font color="red">${message2}</font>:
                                          <input type="text" id="finishMinutes"name="finishMinutes" value="${timeTable.finishMinutes}" maxlength="2" style="ime-mode: disabled; width: 130px;"/>
                                             <font color="red">${message2}</font>
                                      </td>
                                 </tr>
                        </tbody>
                          ...
                          <div style="text-align: center; padding-top: 10px;">
                              <input type="button" id="button_add" name="button_add" value="등록" title="등록" onclick="edit();" /> 
